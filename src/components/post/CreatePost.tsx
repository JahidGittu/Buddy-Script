...
export default function CreatePost({ onPostCreated }: CreatePostProps) {
  ...
  // src/components/post/CreatePost.tsx - শুধুমাত্র handleSubmit function আপডেট করুন
        ...
        <div className="flex-1">
          <div className="relative">
            ...
            <label
              ...
              className={`absolute left-4 top-4 text-gray-500 transition-all duration-200 pointer-events-none flex items-center focus:outline-none ${postContent ? 'opacity-0' : 'opacity-100'
                }`}
            >
              Write something ...
