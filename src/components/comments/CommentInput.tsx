// src/app/components/CommentInput.tsx
...
export default function CommentInput({ commentText, setCommentText, handleCommentSubmit }: CommentInputProps) {
  return (
    <div className="mb-6">
        ...
        <form onSubmit={handleCommentSubmit} className="flex items-center">
          <div className="flex items-center w-full">
            <div className="flex-shrink-0 mr-3">
              <img src="/assets/images/comment_img.png" alt="Profile" className="w-8 h-8 rounded-full"/>
            </div>
          ...
          <div className="flex items-center space-x-2 ml-2">
            <button type="button" className="text-foreground-muted hover:text-primary p-1">
