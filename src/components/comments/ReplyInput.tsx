// src/app/components/ReplyInput.tsx
...
export default function ReplyInput({ replyText, setReplyText, handleReplySubmit }: ReplyInputProps) {
  return (
        ...
        <form onSubmit={handleReplySubmit} className="flex items-center">
          <div className="flex items-center w-full">
            <div className="flex-shrink-0 mr-3">
              <img src="/assets/images/comment_img.png" alt="Profile" className="w-6 h-6 rounded-full"/>
            </div>
